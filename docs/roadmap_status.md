...
- Committed original-document readiness automatically runs one unified compilation
  ...
  task audit-evidence projections, and assignment invalidation remain pending.
...
1. **Complete the guide and task lineage contracts.** CP05 authorization,
   ...
   are complete, with operational/audit reads still internal. ARCH-03B7 requirements projections are complete; the retained requirements route keeps its existing authority wrapper. Next are task audit-evidence projections;
...
- Unified guide: POL-04B1/04B/04B2, POL-05A/AUTH-12F4/POL-05B,
  ...
  Remaining ARCH-03B task audit-evidence projections and invalidation precede ARCH-03C. ARCH-04A supplies registered-capability
