...
Next is ARCH-03C: exact assignment-invalidation authority, atomic producer
wiring and public task integration. Guide activation/intake integration and
...
- Committed original-document readiness automatically runs one unified compilation
  ...
  Submission. Public activation wiring and public TASK queue access, live assignment-invalidation authority and atomic producer wiring remain pending.
...
1. **Integrate the delivered guide/task foundations.** CP08 lineage and
   ...
   listed above. ARCH-03C supplies invalidation's
   real feature authority and atomic producer wiring, plus public task authority
   and exposure. Public guide activation remains
   pending and is not implied by an internal public port. Guide activation requires exact
...
Delivered foundations (not a claim of full public integration)
  ...
  shared dispatcher + hidden exact-assignment invalidation
    |
    v
Remaining integration
  ARCH-03C exact authority, invalidation producer and public task wiring
