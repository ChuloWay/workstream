...
- Committed original-document readiness automatically runs one unified compilation
  ...
  requirements and task audit-evidence projections, and assignment invalidation remain pending.
...
1. **Complete the guide and task lineage contracts.** CP05 authorization,
   ...
   are complete, with operational/audit reads still internal. Next are requirements and task audit-evidence projections;
...
- Unified guide: POL-04B1/04B/04B2, POL-05A/AUTH-12F4/POL-05B,
  ...
  contribution-policy stamps and ARCH-03B1 detached display are available; ARCH-03B2 ready and ARCH-03B3 management/operational queue facts and ARCH-03B4 hidden task detail and ARCH-03B5 current live work context and ARCH-03B6 locked-context projections are delivered.
  Remaining ARCH-03B requirements and task audit-evidence projections and invalidation precede ARCH-03C. ARCH-04A supplies registered-capability
...
- Contribution lineage: CP05 authorization, CP06 validation and hidden `CP07` activation
  ...
  requirements and task audit-evidence projections in `ARCH-03B`, following delivered
