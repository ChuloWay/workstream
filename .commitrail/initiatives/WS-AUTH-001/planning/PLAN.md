...
- [AUTH-12H](chunks/WS-AUTH-001-12H-guide-activation.md) requires completed POL-07B phase composition, CP06
  selected-policy validation and hidden CP07 guide binding. It activates only the complete PROJECTS guide command.
