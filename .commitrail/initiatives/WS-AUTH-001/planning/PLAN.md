...
- [AUTH-12H](chunks/WS-AUTH-001-12H-guide-activation.md) follows delivered POL-07B, then CP06 selected-policy
  validation and hidden CP07 guide binding. It activates only the complete PROJECTS guide command.
