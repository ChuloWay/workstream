...
| `WS-AUTH-001-12H` | Complete internal guide activation authority over the approved current-generation unified chain. CP08, ARCH-03A and ARCH-03B1 are delivered. ARCH-03B queues/actor projections and 03B9 hidden exact invalidation are complete. ARCH-03C real feature authority, atomic producer wiring, registration and public activation come next. CP09 remains later. | POL-07 + corrected AUTH-12B2 + CP05 active ContributionPolicy behavior + CP06 validation + CP07 ProjectGuide binding |
