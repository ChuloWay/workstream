...
- `backend/scripts/api_contract_e2e.py`: replace superseded payment readiness fixtures/assertions with exact activated contribution-policy screening and assignment proof in the existing real HTTP drill.
