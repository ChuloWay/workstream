...
| [WS-ARCH-001-CP07](../WS-ARCH-001-CP07.md) | PROJECTS hidden activation/binding and replacement readiness guard | L1 | Complete; AUTH-12H live manager authority delivered; next CP08 task-attempt lineage, then ARCH-03A complete internal guide facts |
