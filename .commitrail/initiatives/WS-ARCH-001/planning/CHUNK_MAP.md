...
| [WS-ARCH-001-03B3](../WS-ARCH-001-03B3.md) | Hidden all-state management and status-only operational task queues | L1 | Complete; detail/locked-context and audit projections remain 03B; exact AUTH/public access remain 03C |
...
| [WS-ARCH-001-03B](chunks/WS-ARCH-001-03B-task-assignment-api.md) | TASK readiness, claim, assignment and locked-context public commands/facts | L1 | Planned after 03A and CP08; remaining detail/locked-context and audit projections, and invalidation; CP08 owns the minimal lineage writers |
