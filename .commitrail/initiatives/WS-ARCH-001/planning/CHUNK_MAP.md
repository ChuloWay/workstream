...
| [WS-ARCH-001-CP07](../WS-ARCH-001-CP07.md) | PROJECTS hidden activation/binding and replacement readiness guard | L1 | Complete; AUTH-12H live manager authority delivered; next ARCH-03A complete internal guide facts, then CP08 lineage and minimal writers |
...
| [WS-ARCH-001-03A](chunks/WS-ARCH-001-03A-project-current-generation-api.md) | PROJECT current approved unified-generation public facts | L1 | Planned after AUTH-12H and CP07, before CP08; reuse activation receipt without duplicating its write |
