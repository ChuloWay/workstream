...
| [WS-ARCH-001-03B5](../WS-ARCH-001-03B5.md) | Replace existing contributor/manager work context with current projections and complete locked policy identities | L1 | Complete; existing authority retained; 03B8 audit evidence delivered; dependency-gated invalidation remains |
...
| [WS-ARCH-001-03B8](../WS-ARCH-001-03B8.md) | Bounded immutable task audit evidence with atomic project scope and exact transition references | L1 | Complete; Audit Authority/public activation remains 03C; assignment invalidation waits for shared claims |
...
| [WS-ARCH-001-03B](chunks/WS-ARCH-001-03B-task-assignment-api.md) | TASK readiness, claim, assignment and locked-context public commands/facts | L1 | Planned after 03A and CP08; shared claim prerequisites and assignment invalidation; CP08 owns the minimal lineage writers |
