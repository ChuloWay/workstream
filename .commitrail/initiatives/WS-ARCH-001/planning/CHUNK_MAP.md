...
| [WS-ARCH-001-03B3](../WS-ARCH-001-03B3.md) | Hidden all-state management and status-only operational task queues | L1 | Complete; locked-context, requirements and audit projections remain 03B; exact AUTH/public access remain 03C |
| [WS-ARCH-001-03B4](../WS-ARCH-001-03B4.md) | Hidden contributor and management task detail with fixed fields and exact project/assignment visibility | L1 | Complete; locked-context, requirements and audit projections remain 03B; public access remains 03C |
| [WS-ARCH-001-03B5](../WS-ARCH-001-03B5.md) | Replace existing contributor/manager work context with current projections and complete locked policy identities | L1 | Complete; existing authority retained; locked-context, requirements, audit and dependency-gated invalidation remain |
...
| [WS-ARCH-001-03B](chunks/WS-ARCH-001-03B-task-assignment-api.md) | TASK readiness, claim, assignment and locked-context public commands/facts | L1 | Planned after 03A and CP08; remaining locked-context, requirements and audit projections, and invalidation; CP08 owns the minimal lineage writers |
