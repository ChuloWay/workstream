...
- Next usable boundary: remaining ARCH-03B work-context, locked-context, requirements and audit projections
  after completed ARCH-03B4 hidden contributor/management task detail, ARCH-03B3 hidden management/operational queues and ARCH-03B2 contributor-ready queue facts, ARCH-03B1 detached metadata and CP08 lineage
...
1. Completed CP06 validates the expected version against the active policy's current
   ...
   ARCH-03B retains work-context, locked-context, requirements and audit projections and invalidation.
