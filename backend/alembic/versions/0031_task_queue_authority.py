"""Admit only the three exact task queue authorization evidence pairs."""

from alembic import op
import sqlalchemy as sa

revision = "0031_task_queue_authority"
down_revision = "0030_task_management"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    if definition.count(anchor) != 2:
        raise RuntimeError("task queue authority constraint shape changed")
