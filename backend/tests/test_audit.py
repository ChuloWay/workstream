...
def test_action_aware_audit_input_enforces_mapping_and_action_availability() -> None:
    ...
    assert allowed_action_ids == {
        ...
        ActionId.ACTOR_PROFILE_SUSPEND, ActionId.ACTOR_PROFILE_REACTIVATE, ActionId.ACTOR_PROFILE_DEACTIVATE,
        ...
        ActionId.PROJECT_GUIDE_COMPILATION_REQUEST, ActionId.PROJECT_GUIDE_COMPILATION_REQUEST_AUTOMATIC,
        ...
        ActionId.PROJECT_ROLE_GRANT_ISSUE, ActionId.PROJECT_ROLE_GRANT_REVOKE,
        ActionId.PROJECT_SETUP_RUN_READ, ActionId.PROJECT_SETUP_RUN_UPDATE,
        ...
        ActionId.COMPENSATION_ADAPTER_BINDING_READ, ActionId.COMPENSATION_ADAPTER_BINDING_CREATE,
        ActionId.COMPENSATION_ADAPTER_BINDING_SUSPEND, ActionId.COMPENSATION_ADAPTER_BINDING_RESUME,
        ActionId.CONTRIBUTION_POLICY_READ, ActionId.CONTRIBUTION_POLICY_CREATE_DRAFT,
        ActionId.CONTRIBUTION_POLICY_UPDATE_DRAFT, ActionId.CONTRIBUTION_POLICY_PUBLISH, ActionId.CONTRIBUTION_POLICY_RETIRE,
    }
